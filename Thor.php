...
<div class="main">
	...
	<article>
		...
		<img id = "thor" class="image" src = "img/thor_history.png">
...
When Mjolnir was damaged, Doctor Strange bound Thor's soul into Mjolnir, meaning that if the hammer were to be broken again, Thor may die.
		</p>	
	</aside>

	<article>
		<h2 class="content-subhead"> Story </h2>
		<img id = "god" class="image" src = "img/thor2.png">
