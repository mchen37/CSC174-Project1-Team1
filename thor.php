<?php $parentTitle = "SuperHero Central"; $currentTitle = "Thor"; $separator = " | "; $currentBody = "body_gold"; include "inc/top.inc";?>
		...
		<article>
			...
			<img class="img-responsive" src="images/thor_history.png" alt="thor_history">
			...
			<img class="img-responsive" src="images/thor2.png" alt="thor2">
		...
		<aside>
			...
			<ul>
				...
				<li>Dimensional transportation</li>
				<li>Electric manipulation</li>
				<li>Flight</li>
